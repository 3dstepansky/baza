...
- [[entities/helios-agent-environment|Агентская среда «Гелиос» — среда создания и оркестрации агентов на базе C4-онтологии]]
...
- [[entities/hermes|Hermes Agent — инфраструктура 🛠️]]
- [[entities/hr|HR Департамент]]
...
- [[concepts/algo-trading|Алгоритмическая торговля 📈]]
- [[concepts/free-ai-methods|Бесплатное использование нейросетей]]
- [[concepts/hermes-agent-platform|Hermes Agent — Платформа для КПН]]
- [[concepts/kpn-control|Контроль поручений 📋]]
- [[concepts/kpn-llm-wiki|LLM Wiki — интеграция в КПН-Агент 🔄]]
- [[concepts/kpn-requirements|Контроль поручений — Функциональные требования]]
- [[concepts/llm-wiki-rag|Архитектура: LLM Wiki + RAG]]
- [[concepts/llm-wiki|LLM Wiki — концепция и архитектура 🧠]]
- [[concepts/local-llm|Локальные LLM 🏠]]
- [[concepts/mcp-protocol|MCP Protocol — базовый протокол 📡]]
- [[concepts/mcp|MCP — Model Context Protocol 🔌]]
...
- [[comparisons/free-tier-providers|Free-tier LLM провайдеры — сравнение]]
...
- [[queries/lisny-prioritety-zadach-2026-08-25|Лисный — приоритеты задач и автономный AI-отдел]] — приоритеты, двухнедельный коммерческий MVP, статус академразницы, стандартизация документов и автономная команда агентов.
...
- [[raw/articles/spec-kitty-2026|Spec Kitty — source snapshot]]
- [[raw/articles/swe-agent-2026|SWE-agent — source snapshot]]
- [[raw/articles/paul-agent-workflows-2026|PAUL / agent workflow patterns — source snapshot]]
- [[raw/articles/swebench-2026|SWE-bench — source snapshot]]
- [[raw/articles/vscode-multi-agent-development-2026|VS Code multi-agent development — source snapshot]]
