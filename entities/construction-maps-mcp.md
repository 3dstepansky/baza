...
## Контекст для Green Broker и Романа

Этот MCP-сервер связан как **потенциально полезный картографический слой** для [[entities/green-broker|Green Broker]] и садово-питомникового направления: участки, питомники, садовые центры, зоны доставки, геометрия объектов, визуализация на карте и логистика.

По уточнению Павла, сервер нужно держать в контексте как потенциально полезный для **Романа**, ассоциированного с проектом «с садами». Пока в базе нет отдельной страницы/исходника по Роману, поэтому связь зафиксирована как рабочая заметка без расширения персональных данных.

Практические сценарии для садового проекта:

- показать участок/питомник/садовый центр на карте;
- хранить границы территории в GeoJSON;
- считать площадь и пересечения полигонов;
- строить радиусы доставки и зоны обслуживания;
- добавлять спутниковые снимки и статические карты в КП/отчёты;
- связывать заявки Green Broker с географией поставщиков и покупателей.
