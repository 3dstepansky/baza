...
Операционной формой модели служит [[concepts/everything-as-code-for-helios|Everything as Code / Business as Code]]: онтология предприятия хранится версионируемо, проходит ревью и автоматические проверки, а её желаемое состояние сверяется с фактическим исполнением. Для бизнеса drift трактуется двусторонне: иногда исправляется процесс, иногда по наблюдаемым доказательствам обновляется сам манифест. Методология [[concepts/company-game-kifu-and-exploration-map|«Партия компании»]] задаёт единицу модели — атом-задачу, карту разведанности L1–L5, ход агента и кифу трансформации.

Производство агентов наблюдается через [[concepts/helios-extended-burndown-weekly-status-and-sdd-delivery|расширенную диаграмму выгорания и недельный «Статус»]]: заказческий summary преобразуется в SDD, план и задачи субагентов, а экран разделяет исходный и добавленный объём работ и прогнозирует срок завершения с учётом тестирования, доступов и корпоративных согласований.
